...
function [handle,Zi,grid,Xi,Yi] = topoplot_dc_highres(Values,loc_file,varargin)
...
GRID_SCALE = 8*67;        % plot map on a 67X67 grid
CIRCGRID   = 2*201;       % number of angles to use in drawing circles
